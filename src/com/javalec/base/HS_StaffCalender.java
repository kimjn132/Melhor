...
public class HS_StaffCalender extends JFrame implements ActionListener{
	//------------외형구현---------------
	Calendar cal; //케린다
	int year, month, date;
	...
	public HS_StaffCalender() {
		...
		pane.add(monthlb);
		pane.add(btn2);
		pane.setBackground(new Color(227, 147, 132));
